...
const SignUp = () => {
  ...
  return (
    <UnicornBackground className="min-h-screen flex items-center justify-center px-4">
      <motion.div
      ...
      >
        <div className="bg-gradient-to-r from-[#03001417] via-[#03001440] to-[#03001417] backdrop-blur-xl border border-[#ffffff30] rounded-2xl p-8 shadow-[inset_0_1px_2px_rgba(255,255,255,0.4),_0_8px_10px_rgba(0,0,0,0.2)]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Start your journey to becoming a full-stack developer</p>
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-white hover:bg-gray-50 text-gray-900 font-semibold rounded-xl border border-gray-200 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <motion.div
                animate={{ rotate: 360 }}
